...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/cloudflare-app#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/cloudflare-app
```

A live public deployment of this template is available at [https://cloudflare-app.templates.workers.dev](https://cloudflare-app.templates.workers.dev)
